...
main:
    ...
    li $t3, -2147483648           # Número más pequeño posible (para comparar)

    # Bucle para pedir números y encontrar el mayor
...
input_loop:
    ...
    ble $t5, $t3, no_update       # Si el número ingresado es menor o igual, no actualizar
...
show_result:
    li $v0, 4                    # Imprimir "El mayor número es: "
    la $a0, msg_result
    syscall

    li $v0, 1                    # Imprimir el mayor número
    move $a0, $t3
    syscall
